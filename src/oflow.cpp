...
#else
    op.norm_outlier_tmpbsq = (v4sf) norm_outlier2;
    op.norm_outlier_tmp2bsq = op.norm_outlier_tmpbsq * op.twos;
    op.norm_outlier_tmp4bsq = op.norm_outlier_tmpbsq * op.fours;
#endif
